...
models: [
    ...
    {name: 'H2020ridgecrest', stress_type:0,
     label: 'H2020ridgecrest - stress',
     author: 'J.L. Hardebeck',
     description: '<b>H2020ridgecrest</b> model contributed by J.L. Hardebeck. A stress‐similarity triggering model for aftershocks of the Mw 6.4 and 7.1 Ridgecrest earthquakes'},
    {name: 'HM04norcalclusters', stress_type:0,
     label: 'HM04norcalclusters - stress',
     author: 'J.L. Hardebeck and A.J. Michael',
     description: '<b>HM04norcalclusters</b> clusters model contributed by J.L. Hardebeck & A.J. Michael. Stress orientations at intermediate angles to the San Andreas Fault, California'},
    {name: 'HM04norcalfaults', stress_type:0,
     label: 'HM04norcalfaults - stress',
     author: 'J.L. Hardebeck and A.J. Michael',
     description: '<b>HM04norcalfaults</b> fault-based model contributed by J.L. Hardebeck & A.J. Michael. Stress orientations at intermediate angles to the San Andreas Fault, California'},
    {name: 'PEZW02longvalley', stress_type:0,
     label: 'PEZW02longvalley - stress',
     author: 'S. Prejean, W. Ellsworth, M. Zoback, and F. Waldhauser',
     description: '<b>PEZW02longvalley</b> model contributed by S. Prejean, W. Ellsworth, M. Zoback, and F. Waldhauser. Fault structure and kinematics of the Long Valley Caldera region, California, revealed by high-accuracy earthquake hypocenters and focal mechanism stress inversions'},
    {name: 'PH01creepingTable1', stress_type:0,
     label: 'PH01creepingTable1 - stress',
     author: 'A.S. Provost and H. Houston',
     description: '<b>PH01creepingTable1</b> model contributed by A.S. Provost and H. Houston. Orientation of the stress field surrounding the creeping section of the San Andreas Fault: Evidence for a narrow mechanically weak fault zone, table 1'},
    {name: 'PH01creepingTable2', stress_type:0,
     label: 'PH01creepingTable2 - stress',
     author: 'A.S. Provost and H. Houston',
     description: '<b>PH01creepingTable2</b> model contributed by A.S. Provost and H. Houston. Orientation of the stress field surrounding the creeping section of the San Andreas Fault: Evidence for a narrow mechanically weak fault zone, table 2'},
    {name: 'PH03norcal', stress_type:0,
     label: 'PH03norcal - stress',
     author: 'A.S. Provost and H. Houston',
     description: '<b>PH03norcal</b> model contributed by A.S. Provost and H. Houston. Stress orientations in northern and central California: Evidence for the evolution of frictional strength along the San Andreas plate boundary system'},
    {name: 'SHS23mtlewis', stress_type:0,
     label: 'SHS23mtlewis - stress',
     author: 'R.J. Skoumal, J.L. Hardebeck and D.R. Shelly',
     description: '<b>SHS23mtlewis</b> model contributed by R.J. Skoumal, J.L. Hardebeck and D.R. Shelly. Using corrected and imputed polarity measurements to improve focal mechanisms in a regional earthquake catalog near the Mt. Lewis Fault Zone, California'}],
metrics: [
