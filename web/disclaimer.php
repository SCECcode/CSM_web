...
<head>
    ...
    <title>SCEC Community Stress Model Web Tool: Disclaimer</title>
</head>
<body>
<?php echo $header; ?>
...
<div class="container info-page-container scec-main-container">
    ...
    <h1>Disclaimer</h1>
    <div>
       <p>The Community Stress Model (CSM) Web Tool is provided “as is” and without warranties 
	  ...
	  team do not intend the results provided by this tool to replace the sound judgment of a
	  competent professional, who has knowledge and experience in the appropriate field(s) of 
	  practice. By using this tool, you accept to release SCEC and the CSM development team of 
