...
<head>
    ...
    <title>Community Stress Model Web Tool: User Guide</title>
</head>
<body>
<?php echo $header; ?>
...
<div class="container info-page-container scec-main-container guide">
    ...
    <h1>CSM Web Tool User Guide</h1>
        <div class="col-12">
            <figure class="cxm-interface figure float-lg-right">
                <img src="img/csm-viewer.png" class="figure-img img-fluid" alt="Screen capture of CSM web tool interface">
                <figcaption class="figure-caption">Screen capture of CSM web tool interface</figcaption>
            </figure>
            <h4><strong>Community Stress Model (CSM) Web Tool Overview</strong></h4>

		<p>The CSM web tool provides interactive map-based views of the 
                   <a href="https://doi.org/10.5281/zenodo.8270631">CSM v2023</a> 
		   contributed models.  The web tool allows users to select the model of interest, a 
		   ...
		   <a href="<?php echo $host_site_actual_path; ?>">CSM web tool page</a>, this user guide,
		 ...
		 <p>The CSM web tool has two modes: “Explore Models”, and “Select Region”, accessed by the 
		 ...
		 <p>The “Select Model Metric” dropdown menu lists available scalar metrics, a brief description,
		    ...
		    available for the selected model, the web tool will display the notification “switching to a 
		 ...
		 <p>Users can select the depth of interest using the “Select Model Depth” dropdown menu.  Note 
		    ...
		    light gray).  If you select a depth that is not available for the selected model, the web tool
		    ...
		    a model that does not vary with depth, the interactive web tool will update but the image will 
                    not change.</p>
